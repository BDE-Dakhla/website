...
const Animated: React.FC<React.InputHTMLAttributes<HTMLInputElement>> = ({
  ...
  return (
    <input
      className={cn(
        'relative box-border block h-5 w-5 cursor-pointer appearance-none border border-[#d9d9d9] bg-slate-200 transition-all duration-300',
        'before:absolute before:top-[42%] before:left-2/4 before:h-2 before:w-1',
        ...
        "after:shadow-[0_0_0_calc(30px/2.5)_#1677ff] after:transition-all after:duration-500 after:ease-in after:content-['']",
