...
const AUTH_ERROR_MESSAGES: AuthErrorMessages = {
  Configuration: {
    ...
    message:
      'Un problème de configuration a été détecté. Veuillez réessayer dans quelques instants.',
    type: 'error',
  },
  AccessDenied: {
    title: 'Accès refusé',
    message:
      "Votre compte n'est pas autorisé à accéder à cette application. Utilisez votre email @edu.uiz.ac.ma",
    type: 'error',
  },
  Verification: {
  ...
  OAuthSignin: {
    title: 'Erreur OAuth',
    message:
      'Impossible de se connecter avec Google. Vérifiez votre connexion internet.',
    type: 'error',
  },
  OAuthCallback: {
    title: 'Erreur de connexion Google',
    message:
      'La connexion avec Google a échoué. Cela peut être dû à un problème de réseau.',
    type: 'error',
  },
  OAuthCreateAccount: {
    title: 'Erreur de création de compte',
    message:
      'Impossible de créer votre compte. Contactez le support technique.',
    type: 'error',
  },
  EmailCreateAccount: {
    title: 'Erreur de création de compte',
  ...
  Callback: {
    ...
    message:
      "Une erreur s'est produite lors de la connexion. Vérifiez votre connexion internet et réessayez.",
    type: 'error',
  },
